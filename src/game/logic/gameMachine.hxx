...
struct GameMachine
{
  GameMachine (std::vector<std::shared_ptr<User>> users) : durakStateMachine{ my_logger{}, PassAttackAndAssist{}, AttackAndAssistAnswer{}, _game, _users }, _users{ users }
  {
  ...
  GameMachine (durak::Game const &game, std::vector<std::shared_ptr<User>> &users) : durakStateMachine{ my_logger{}, PassAttackAndAssist{}, AttackAndAssistAnswer{}, _game, _users }, _game{ game }, _users{ users } {}
